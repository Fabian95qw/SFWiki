...
Vorkompilliertes Installationspaket 9.X oder älter: https://github.com/Fabian95qw/PRTG-2-Starface/raw/master/bin/client/PRTGClientV).rar (muss noch entpackt werden)
Vorkompilliertes Installationspaket 10.X oder neuer: https://github.com/Fabian95qw/PRTG-2-Starface/raw/master/bin/client/PRTGClientV).rar (muss noch entpackt werden)
